//
//  PredictiveAccelerationStatusFeature.swift
//  
...
public class PredictiveAccelerationStatusFeature: BaseFeature<PredictiveAccelerationStatusData> {
    ...
    override func extractData<T>(with timestamp: UInt64, data: Data, offset: Int) -> FeatureExtractDataResult<T> {
        ...
        let parsedData = PredictiveAccelerationStatusData(with: data, offset: offset)
