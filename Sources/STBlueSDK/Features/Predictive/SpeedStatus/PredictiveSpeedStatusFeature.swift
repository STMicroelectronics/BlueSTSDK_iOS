//
//  PredictiveSpeedStatusFeature.swift
//  
...
public class PredictiveSpeedStatusFeature: BaseFeature<PredictiveSpeedStatusData> {
    ...
    override func extractData<T>(with timestamp: UInt64, data: Data, offset: Int) -> FeatureExtractDataResult<T> {
        ...
        let parsedData = PredictiveSpeedStatusData(with: data, offset: offset)
