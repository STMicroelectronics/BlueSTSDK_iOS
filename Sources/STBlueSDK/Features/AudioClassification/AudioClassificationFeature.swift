//
//  AudioClassificationFeature.swift
//  
...
public class AudioClassificationFeature: BaseFeature<AudioClassificationData> {
    ...
    override func extractData<T>(with timestamp: UInt64, data: Data, offset: Int) -> FeatureExtractDataResult<T> {
        ...
        let parsedData = AudioClassificationData(with: data, offset: offset)
