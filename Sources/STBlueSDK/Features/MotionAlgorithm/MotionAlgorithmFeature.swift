...
public class MotionAlgorithmFeature: BaseFeature<MotionAlgorithmData> {
    ...
    override func extractData<T>(with timestamp: UInt64, data: Data, offset: Int) -> FeatureExtractDataResult<T> {
        ...
        let parsedData = MotionAlgorithmData(with: data, offset: offset)
