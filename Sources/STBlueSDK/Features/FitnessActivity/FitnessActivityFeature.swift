...
public class FitnessActivityFeature: BaseFeature<FitnessActivityData> {
    ...
    override func extractData<T>(with timestamp: UInt64, data: Data, offset: Int) -> FeatureExtractDataResult<T> {
        ...
        let parsedData = FitnessActivityData(with: data, offset: offset)
