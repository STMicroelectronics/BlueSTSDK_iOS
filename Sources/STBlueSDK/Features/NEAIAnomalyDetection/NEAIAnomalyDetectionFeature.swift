//
//  NEAIAnomalyDetectionFeature.swift
//  
...
public class NEAIAnomalyDetectionFeature: BaseFeature<NEAIAnomalyDetectionData> {
    ...
    let packetLength = 9
     ...
     override func extractData<T>(with timestamp: UInt64, data: Data, offset: Int) -> FeatureExtractDataResult<T> {
        ...
        let parsedData = NEAIAnomalyDetectionData(with: data, offset: offset)
