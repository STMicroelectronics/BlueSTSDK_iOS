...
public class MotionIntensityFeature: BaseFeature<MotionIntensityData> {
    ...
    override func extractData<T>(with timestamp: UInt64, data: Data, offset: Int) -> FeatureExtractDataResult<T> {
        ...
        let parsedData = MotionIntensityData(with: data, offset: offset)
