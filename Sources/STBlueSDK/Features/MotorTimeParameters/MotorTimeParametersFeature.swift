//
//  MotorTimeParametersFeature.swift
//  
...
public class MotorTimeParametersFeature: BaseFeature<MotorTimeParametersData> {
    ...
    override func extractData<T>(with timestamp: UInt64, data: Data, offset: Int) -> FeatureExtractDataResult<T> {
        ...
        let parsedData = MotorTimeParametersData(with: data, offset: offset)
