...
extension FiniteStateMachineData: CustomStringConvertible {
    public var description: String {
        ...
        return descr.count > 0 ? descr : "No register available"
    }
}

extension FiniteStateMachineData: Loggable {
